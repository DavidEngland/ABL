Here’s a compact, WRF‑style F90 module you can drop into your physics library and wire into the surface‑layer scheme. It includes:

• Canonical Businger–Dyer constants (Dyer 1974 default)
• Piecewise φ_m, φ_h for unstable/stable
• Simple clipping of ζ to a configurable range
• Clean hooks to extend with alternative parameter sets (Högström, SHEBA, etc.)
...
How you might wire this into WRF

• use most_similarity, only: phi_m, phi_h, kappa_most, set_param_dyer1974
• Call one of the set_param_* routines during initialization (e.g., in the surface‑layer init).
• Replace any hard‑coded φ_m, φ_h expressions with calls to phi_m(zeta) and phi_h(zeta).


If you’d like, next step I can:

• Add ψ_m, ψ_h integrals in the same module (Kansas forms), and/or
• Add a second set of functions phi_m_stable_ext, phi_h_stable_ext for Cheng–Brutsaert or SHEBA with a regime switch at, say, ζ > 1.