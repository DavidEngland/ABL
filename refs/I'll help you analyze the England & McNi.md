I'll help you analyze the England & McNider (1995) paper and address the reported errors. Let me search for and correct the formulations.

### [find_mcnider_refs.py](file:///Users/davidengland/Documents/GitHub/ABL/code/find_mcnider_refs.py)

Already created - use this to find all references first.
...
Complete analysis of the 1995 paper errors and corrected formulations.
...
Now run the reference finder to locate all files citing this paper:

```bash
cd /Users/davidengland/Documents/GitHub/ABL
python code/find_mcnider_refs.py . --output mcnider_1995_citations.txt --verbose
```

This will identify every document that needs the correction applied.
Now run the reference finder to locate all files citing this paper:
